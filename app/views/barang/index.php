...
<main role="main" class="container">
    <div class="clearfix mb-3 mt-3">
        ...
        <form class="form-inline float-right" action="<?= URL . '/barang/index' ?>" method="GET">
            <input class="form-control mr-sm-2" type="search" placeholder="Cari barang" aria-label="Search" name="NamaBarang">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php if (isset($barang->iduser)) echo $barang->username; ?></td>
